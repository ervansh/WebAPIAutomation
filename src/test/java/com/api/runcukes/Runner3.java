...
@CucumberOptions(
		features = "src/test",
		plugin = {"com.api.report.xls.XLSOutputFormatter","pretty", "html:target/WEBAPI-report","json:target/WebAPI.json"},
		glue = {"com.api.dataprovider","com.api.stepdefinition","com.api.utils"},
	    monochrome = true,
		tags= {"~@MediaResearch","~@TargetedLists"}
	    //tags= {"@OutletBounceBacks"}

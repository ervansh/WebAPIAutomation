@ListAllContactV2 @TargetedLists @TargetedListsV2
Feature: ||TargetedLists|| ListAllContact Endpoint || API V2 ||
  ...
  Scenario Outline: 1.Call TargetedListSummary Endpoint and get the list of all contacts in a targeted list
    ...
    Examples: 
      ...
      | v2      | TargetedListID | Z5vVPOJcDCi9bZNbjo8K9xO4LgAGeFmfj0CW7uiKq/o= | apiOutletContactID | firstName  |

  @ListAllContactUsingItemPerPage @API-V2
  Scenario Outline: 2. Call TargetedListSummary Endpoint and get the list of all contacts in a targeted list using itemsPerPage
    ...
    Examples: 
      ...
      | v2      | TargetedListID | limit      |     1 | ReturnedResults | firstName  |

  #@SortByApiOutletContactIDASC @API-V2
  ...
  #                  5. Call TargetedListSummary Endpoint and list of all contacts using sortBy first name in ASC
   # When Login in to API
    ...
    #Examples: 
      ...
      #| v2      | TargetedListID | sort       | order      | ApiOutletContactID | ASC    | apiOutletContactID | firstName  |
      #| v2      | TargetedListID | sort       | order      | ContactName        | ASC    | contactName        | firstName  |

  #@SortByApiOutletContactIDDESC @API-V2

@RemovedContactsV2 @UpdatedAndRemoved
Feature: ||UpdatedAndRemoved || Removed Contacts Endpoint || API V2 ||
         1.Call webservices of Removedcontact Endpoint without parameter and verify response

  @RemovedContactslistwithNoChnageInParameter @WEBAPIAutomation @API-V2 @Sanity

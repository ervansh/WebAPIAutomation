@RemovedOutletsv2 @UpdatedAndRemoved
Feature: ||UpdatedAndRemoved || Removed Outlets Endpoint  || API V2 ||
         1.Call webservices of Removed Outlets without parameter and verify response

  @RemovedOutletslistwithNoChnageInParameterv2 @WEBAPIAutomation @API-V2 @Sanity

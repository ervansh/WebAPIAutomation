@CreateNewTargetedList @TargetedLists @TargetedListsV2.1
Feature: ||TargetedLists|| CREATENewTargetedList Endpoint || API V2.1 ||
  ...
  @CreateNewTargetedList @TargetedLists @API-V2.1 @Sanity
  Scenario Outline: 1. Call CREATENewTargetedList Endpoint and Create a new Targeted Lists and verify the response
    ...
    Examples: 
      ...
      | v2.1    | listName   | apiOutletContactIds | TargetedList-Sonali | XE818YyjFFjMWklV20QINtYptQfcRkc7kklnpLEDMx4= | targetedListID | targetedListName |

  @CreateNewTargetedListUsingList @TargetedLists @API-V2.1
  Scenario Outline: 2. Call CREATENewTargetedList Endpoint and Create a new Targeted Lists using a already created list and verify the response
    ...
    Examples: 
      ...
      | v2.1    | listName   | apiOutletContactIds | targetedListIds | TargetedList-Sonali | Z5vVPOJcDCi9bZNbjo8K9xO4LgAGeFmfj0CW7uiKq/o= | targetedListID | targetedListName |

@ContactViewV2.1 @ContactView @Views
Feature: || Views || ContactView Endpoint ||API V2.1||
  ...
  @ContactViewWithSingleAPIOutletContactIDV2.1 @ContactViewV3 @API-V2.1 
  Scenario Outline: 1. Call webservices of contactview with single apiOutletContactId and verify the response
    ...
    Examples: 
      ...
      | v2.1    | apiOutletContactId | XE818YyjFFjMWklV20QINtYptQfcRkc7kklnpLEDMx4= | contactName | Adam Thomas | outletName | Dumbarton & Vale of Leven Reporter | email     | adam.thomas@newsquest.co.uk  | phoneNumber | + 44  141 435 8888 |

  @ContactViewWithMultipleIdsV2.1 @API-V2.1 @Sanity
  Scenario Outline: 2. Call webservices of contactview with Multiple apiOutletContactId and verify the response
    ...
    Examples: 
      ...
      | v2.1    | apiOutletContactId | apiOutletContactId | contactName |

  @ContactViewIDSortByASCV2.1 @API-V2.1
  Scenario Outline: 3. Call webservices of Using sortBy Name in ASC Order and verify the response
    ...
    Examples: 
      ...
      | v2.1    | apiOutletContactId | apiOutletContactId | contactName | contactName |     1 |

  @ContactViewIDSortByDESCV2.1 @API-V2.1
  Scenario Outline: 4. Call webservices of Using sortBy Name in DSC Order and verify the response
    ...
    Examples: 
      | Version | parameter          | FieldName1         | FieldName2  | sortBy      | order |
      | v2.1    | apiOutletContactId | apiOutletContactId | contactName | contactName |     2 |

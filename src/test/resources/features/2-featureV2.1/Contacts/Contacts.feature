@ContactsV2.1 @Contacts
Feature: || Contacts Endpoint || API V2.1 ||
  ...
  @contactlistwithNoParameterv2.1 @WEBAPIAutomation @API-V2.1
  ...
  @contactlistwithSingleParameterv2.1 @WEBAPIAutomation @API-V2.1
  Scenario Outline: 2.Call webservice to get the contact list using single parameter and verify response
    ...
    Examples: 
      ...
      | apiOutletContactIds | L3gnHqTZIAkI5mougxu/kCSsxWskhYMTark+CiIM3T8= | apiOutletContactId | v2.1    |
      | contactNames        | Aaron Thomas                                 | contactName        | v2.1    |
      | outletNames         | KVLD-FM                                      | outletName         | v2.1    |
      | apiOutletIds        | H6iW/7BMp3+26kR5C2pwFA==                     | apiOutletId        | v2.1    |
      | apiContactIds       | 9FtsXCIr/RK2bpCqaw3Afg==                     | apiContactId       | v2.1    |

  @contactlistwithtwoParameterv2.1 @WEBAPIAutomation @API-V2.1
  Scenario Outline: 3.Call webservices to get the contact list using two parameter and verify response
    ...
    Examples: 
      ...
      | names      | Thomas | /api/2.1/data/subjectLookup    | subjectSearch       | v2.1    |
      | names      | Thomas | /api/2.1/data/jobRoleLookup    | jobRoles            | v2.1    |
      | names      | Thomas | /api/2.1/data/geographyLookup  | locatedIn           | v2.1    |
      | names      | Thomas | /api/2.1/data/languageLookup   | languages           | v2.1    |
      | names      | Thomas | /api/2.1/data/frequencyLookup  | frequencies         | v2.1    |
      | names      | John   | /api/2.1/data/newsFocusLookup  | newsFocuses         | v2.1    |
      | names      | John   | /api/2.1/data/mediaTypeLookup  | mediaTypes          | v2.1    |
      | names      | John   | /api/2.1/data/outletTypeLookup | outletTypes         | v2.1    |
      | names      | John   | /api/2.1/data/subjectLookup    | outletSubjectSearch | v2.1    |

  @contactlistwithSubjectParameterv2.1 @WEBAPIAutomation @API-V2.1 @Sanity
  Scenario Outline: 4.Call webservices to get the contact list using Subject parameter and verify response
    ...
    Examples: 
      ...
      | writingAbout       |  1414 | v2.1    |
      | outletWritingAbout |  1414 | v2.1    |

  @contactlistwithAllParameterv2.1 @WEBAPIAutomation @API-V2.1 @Sanity
  Scenario Outline: 5.Call webservices to get the contact list and verify response
    ...
    Examples: 
      ...
      | apiContactIds | 5vCnAa+eKPuymQNdSEQV2g== | apiOutletContactIds | jKlIfX4z33Ql8AeWpP8gVTbYtKrWzVSiLK4Va9z+Sy4= | names      | Retd) John | subjectSearch |    698 | jobRoles   |      4 | mediaTypes |      4 | frequencies |      7 | outletNames | Tank Magazine | apiOutletIds | gzZ6TZEpI9MzSWV+PTL7yA== | outletSubjectSearch |     698 | v2.1    |

  @contactlistwithThreeParameterv2.1 @WEBAPIAutomation @API-V2.1
  Scenario Outline: 6.Call webservices to get the contact list using three parameter and verify response
    ...
    Examples: 
      ...
      | apiContactIds | 5vCnAa+eKPuymQNdSEQV2g== | apiOutletContactIds | jKlIfX4z33Ql8AeWpP8gVTbYtKrWzVSiLK4Va9z+Sy4= | names      | Retd) John | v2.1    |

  @contactlistwithTwitterHandlev2.1 @API-V2.1
  Scenario Outline: 7.Call webservices to get the contact list using twitter handle and verify response
    ...
    Examples: 
      ...
      | names     | Thomas         | true               | twitterHandleRequired | v2.1    |

  @contactlistwitIndexParameterv2.1 @API-V2.1
  Scenario Outline: 8.Call webservices to get the contact list using index parameter and verify response
    ...
    Examples: 
      ...
      | names     | Thomas         | pageIndex  |     1 | v2.1    |

  @contactlistWithItemsPerPageParameterv2.1 @API-V2.1
  Scenario Outline: 9.Call webservices to get the contact list using item per page and verify response
    ...
    Examples: 
      ...
      | names     | Thomas         | itemsPerPage |              50 | v2.1    |

  @contactWithSortByASCv2.1 @API-V2.1
  Scenario Outline: 10.Call webservices to get the contact list using sort by ASC and verify response
    ...
    Examples: 
      ...
      | names      | Thomas          | sortBy     |               1 | order      |               1 | contactName | v2.1    |
      | names      | Thomas          | sortBy     |               3 | order      |               1 | JobTitle    | v2.1    |
      | names      | Thomas          | sortBy     |               4 | order      |               1 | MediaType   | v2.1    |
      | names      | Thomas          | sortBy     |               5 | order      |               1 | Country     | v2.1    |
      | names      | Thomas          | sortBy     |               6 | order      |               1 | City        | v2.1    |
      | names      | Thomas          | sortBy     |               7 | order      |               1 | LastName    | v2.1    |
      | names      | Thomas          | sortBy     |               8 | order      |               1 | Audience    | v2.1    |

  @contactWithSortByDESCv2.1 @API-V2.1
  Scenario Outline: 11.Call webservices to get the contact list using sort by DSC and verify response
    ...
    Examples: 
      | Parameter1 | parameterValue1 | parameter2 | parameterValue2 | parameter3 | parameterValue3 | value       | Version |
      | names      | Thomas          | sortBy     |               1 | order      |               2 | contactName | v2.1    |
      | names      | Thomas          | sortBy     |               2 | order      |               2 | outletName  | v2.1    |
      | names      | Thomas          | sortBy     |               3 | order      |               2 | JobTitle    | v2.1    |
      | names      | Thomas          | sortBy     |               4 | order      |               2 | MediaType   | v2.1    |
      | names      | Thomas          | sortBy     |               5 | order      |               2 | Country     | v2.1    |
      | names      | Thomas          | sortBy     |               6 | order      |               2 | City        | v2.1    |
      | names      | Thomas          | sortBy     |               7 | order      |               2 | LastName    | v2.1    |
      | names      | Thomas          | sortBy     |               8 | order      |               2 | Audience    | v2.1    |

  @contactWithSmartSortv2.1 @API-V2.1
  Scenario Outline: 12.Call webservices to get the contact list using smart sort and verify response
    ...
    Examples: 
      ...
      | names     | Thomas         | smartSort  | true            | contactName | v2.1    |
      | names     | Thomas         | smartSort  | true            | JobTitle    | v2.1    |
      | names     | Thomas         | smartSort  | true            | MediaType   | v2.1    |

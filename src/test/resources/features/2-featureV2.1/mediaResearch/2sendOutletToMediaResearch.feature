@MediaResearchForOutletV2.1 @MediaResearch
Feature: ||MediaResearch || SendOutletToMediaResearch Endpoint || API v2.1 ||
  ...
  @AddOutletToMediaResearchv3 @API-v2.1 @Sanity
  ...
  @UpdateOutletNEmailToMediaResearch @API-v2.1
  Scenario Outline: 2.1. Call sendOutletToMediaResearch webservice to update Outlet and verify response
    ...
    Examples: 
      ...
      | v2.1      | hgCuk8Wp0lKsibO713zPMA== | snl1@test.com |
  ...
  Scenario Outline: 2.2. Call sendOutletToMediaResearch webservice to update phone no and verify response
    ...
    Examples: 
      | Version | OutletId                 | Email        |
      | v2.1      | hgCuk8Wp0lKsibO713zPMA== | snl@test.com |

...
Feature: ||MediaResearch || ContactBounceBacks Endpoint|| API V2.1 ||
         1. Call ContactBounceBacks webservice and verify response

  @ContactBounceBacks @API-V2.1
  Scenario Outline: 1. Call ContactBounceBacks webservice and verify response
    ...
    Examples: 
      ...
      | apiOutletContactId | L3gnHqTZIAkI5mougxu/kCSsxWskhYMTark+CiIM3T8= | v2.1      | bounceBackEmail |

@Outlets @API-V3
Feature: || Outlets Endpoint ||API V3||
  ...
  @OutletlistwithNameParameter @API-V3
  Scenario Outline: 1. API V3||  Outlets || Using only name parameter
  ...
  @OutletlistwithSubjectParameter @API-V3 @Sanity
  Scenario Outline: 2. API V3||  Outlets || Using only Subject parameter
    When Login in to API
    ...
    Examples: 
      ...
      | subjectSearch | News - other | v3      | /api/v3/data/subjectLookup | subjectIds | id         |

  @OutletlistwithOutlettypeParameter @API-V3
  Scenario Outline: 3. API V3||  Outlets || Using only Outlet type parameter
    When Login in to API
    When Call looksups API "<endpointURL>"
    ...
    Examples: 
      ...
      | outletTypes | print/online   | v3      | /api/v3/data/outletTypeLookup | Financial outlet | outletType |

  @OutletlistwithFrequencyParameter @API-V3
  Scenario Outline: 4. API V3||  outlet list using only frequency parameter and verify response
    When Login in to API
    When Call looksups API "<endpointURL>"
    ...
    Examples: 
      ...
      | frequencies | Daily         | v3      | /api/v3/data/frequencyLookup | frequency  |

  @OutletlistwithMediaTypeParameter @API-V3
  Scenario Outline: 5. API V3||  outlet list using only media type parameter and verify response
    When Login in to API
    When Call looksups API "<endpointURL>"
    ...
    Examples: 
      ...
      | mediaTypes  | online        | v3      | /api/v3/data/mediaTypeLookup | primaryMediaType | Freelancer     |

  @OutletlistwithTwoParameterV3 @API-V3
  Scenario Outline: 6. API V3||  Outlets || Using Two parameters
    When Login in to API
    ...
    Examples: 
      ...
      | names  | bbc    | frequencies |      3 | frequencyLookup |        1 | outletName    | frequency     | v3      | /api/v3/data/frequencyLookup |

  @OutletlistwithThreeParameterV3 @API-V3
  Scenario Outline: 7. API V3||  Outlets || Using Three parameters
    When Login in to API
    ...
    Examples: 
      ...
      | names  | bbc    | frequencies |      2 | mediaTypes |     10 | frequencyLookup |         1 | mediaTypeLookup |         7 | outletName    | frequency     | primaryMediaType | v3      | /api/v3/data/frequencyLookup | /api/v3/data/mediaTypeLookup |

  @OutletlistwithAllParameterV3 @API-V3 @Sanity
  Scenario Outline: 8. API V3||  Outlets || Using All parameter
    When Login in to API
    ...
    Examples: 
      ...
      | names  | bbc    | writingAbout |   1409 | areasOfCoverage |  54271 | frequencies |      2 | mediaTypes |     10 | twitterHandleRequired | true   |              |           |              |           | v3      |

  @OutletlistwithapiOutletIdsV3 @API-V3
  Scenario Outline: 9. API V3||  Outlets || Using APIOutletId parameter
    When Login in to API
    ...
    Examples: 
      | Parameter    | parameterValue           | Version |
      | apiOutletIds | FOCQrIipn63WUXvCppsiNg== | v3      |

  @OutletlistwithTwitterHandleV3 @API-V3
  Scenario Outline: 10. API V3||  Outlets || Using twitterHandleRequired as true
    When Login in to API
  ...
  @OutletlistwitIndexParameterV3 @API-V3
  Scenario Outline: 11. API V3||  Outlets || Using Index parameter and verify response
    When Login in to API
  ...
  @OutletlistWithItemsPerPageParameterV3 @API-V3
  Scenario Outline: 12. API V3||  Outlets || Using Items Per Page parameter and verify response
    When Login in to API
  ...
  @OutletWithSortByASCV3 @API-V3
  Scenario Outline: 13. API V3||  Outlets || Using Sortby ASC
    When Login in to API
    ...
    Examples: 
      ...
      | names     | bbc            |      1 |     1 | outletName       | v3      |
      | names     | bbc            |      2 |     1 | outletType       | v3      |
      | names     | bbc            |      3 |     1 | primaryMediaType | v3      |
      | names     | bbc            |      4 |     1 | country          | v3      |

  @OutletWithSortByDESCV3 @API-V3
  Scenario Outline: 14. API V3||  Outlets || Using Sortby DESC
    When Login in to API
    When List of outlets exists with the parameter "<Parameter>" value "<parameterValue>" and sort by "<sortby>", "<order>","<Version>"
    And Verify the status code is 200
    ...
    Examples: 
      | Parameter | parameterValue | sortby | order | value            | Version |
      | names     | bbc            |      1 |     0 | outletName       | v3      |
      | names     | bbc            |      2 |     0 | outletType       | v3      |
      | names     | bbc            |      3 |     0 | primaryMediaType | v3      |
      | names     | bbc            |      4 |     0 | country          | v3      |

  @OutletWithSmartSortV3 @API-V3
  Scenario Outline: 15. API V3||  Outlets || Using Smart sort as true
    When Login in to API

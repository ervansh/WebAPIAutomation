@contactQuickSearchV3 @Search
Feature: ||Search ||ContactQuickSearch Endpoint ||API V3||
  ...
  @contactnameQuickSearch @API-V3 @Sanity
  ...
  Scenario Outline: 2. Call Two Parameter Keyword search webservice and verify response
    ...
    Examples: 
      ...
      | v3      | name       | Thomas | geographyIds |  54295 |
  ...
  Scenario Outline: 3. Call ContactQuickSearch webservice for sort by ASC and verify response
    ...
    Examples: 
      ...
      | v3      | name       | Thomas | sortBy     |      1 | contactName |

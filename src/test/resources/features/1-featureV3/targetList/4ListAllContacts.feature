@ListAllContactV3 @TargetedLists @TargetedListsV3
Feature: ||TargetedLists|| ListAllContact Endpoint || API V3 ||
  ...
  Scenario Outline: 1.  Call TargetedListSummary Endpoint and get the list of all contacts in a targeted list
    ...
    Examples: 
      ...
      | v3      | targetedListId | Z5vVPOJcDCi9bZNbjo8K9xO4LgAGeFmfj0CW7uiKq/o= | apiOutletContactId | firstName  |

  @ListAllContactUsingItemPerPage @API-V3
  Scenario Outline: 2.  Call TargetedListSummary Endpoint and get the list of all contacts in a targeted list using itemsPerPage
    ...
    Examples: 
      ...
      | v3      | targetedListId | itemsPerPage |     1 | currentItemCount | firstName  |

  #@SortByApiOutletContactIDASC @API-V3
  #Scenario Outline: 3.  Call TargetedListSummary Endpoint and list of all contacts using sortBy outletContactId in ASC | 
  #                 5.  Call TargetedListSummary Endpoint and list of all contacts using sortBy first name in ASC
   # When Login in to API
    ...
    #Examples: 
      ...
      #| v3      | targetedListId | sortBy     | order      | ApiOutletContactID | ASC    | apiOutletContactId | firstName  |
      #| v3      | targetedListId | sortBy     | order      | ContactName        | ASC   | firstName          | firstName  |

  #@SortByApiOutletContactIDDESC @API-V3
  ...
  #                   6.  Call TargetedListSummary Endpoint and list of all contacts using sortBy first name in DESC
    ...
    #Examples: 
      #| Version | Parameter1     | Parameter2 | Parameter3 | Value1             | Value2 | fieldName1         | fieldName2 |
      #| v3      | targetedListId | sortBy     | order      | ApiOutletContactID | DESC   | apiOutletContactId | firstName  |
      #| v3      | targetedListId | sortBy     | order      | ContactName        | DESC   | firstName          | firstName  |

@Outlets @API-V2 @Outlets @Depricated
Feature: || Outlets Endpoint ||API v2Depricated||
  ...
  Scenario Outline: 1. Call Outlets webservice with only name parameter
    ...
    Examples: 
      ...
      | Names     | BBC            | v2Depricated |

  @OutletlistwithSubjectParameterD @API-V2 @Sanity
  Scenario Outline: 2. Call Outlets webservice with only Subject parameter
    ...
    Examples: 
      ...
      | WritingAbout | News - other | v2Depricated | /api/v3/data/subjectLookup | outletSubjectIDs | id         |

  @OutletlistwithOutlettypeParameter @API-V
  Scenario Outline: 3. Call Outlets webservice with only Outlet type parameter
    ...
    Examples: 
      ...
      | OutletTypes | print/online   | v2Depricated | /api/v2/agilitydata/outletTypeLookup | Feature    | outletType |
  ...
  Scenario Outline: 4. Call Outlets webservice with only frequency parameter
    ...
    Examples: 
      ...
      | Frequencies | Annually      | v2Depricated | /api/v2/agilitydata/frequencyLookup | outletFrequencyNames |
  ...
  Scenario Outline: 5. Call Outlets webservice with only media type parameter
    ...
    Examples: 
      ...
      | MediaTypes  | online        | v2Depricated | /api/v2/agilitydata/mediaTypeLookup | primaryMediaType | Freelancer     |
  ...
  Scenario Outline: 6. Call Outlets webservice with Two parameters
    ...
    Examples: 
      ...
      | Names  | bbc    | Frequencies |      3 | frequencyLookup |        1 | outletName    | outletFrequencyNames | v2Depricated | /api/2.1/data/frequencyLookup |

  @OutletlistwithThreeParameter @API-V2
  Scenario Outline: 7. Call Outlets webservice with Three parameters
    ...
    Examples: 
      ...
      | Names  | bbc    | Frequencies |      2 | MediaTypes |     10 | FrequencyLookup |         1 | MediaTypeLookup |         7 | outletName    | outletFrequencyNames | primaryMediaType | v2Depricated | /api/2.1/data/frequencyLookup | /api/2.1/data/mediaTypeLookup |

  @OutletlistwithAllParameter @API-V2 @Sanity
  Scenario Outline: 8. Call Outlets webservice with All parameter
    ...
    Examples: 
      ...
      | Names  | bbc    | WritingAbout |   1409 | AreasOfCoverage |  54271 | Frequencies |      2 | MediaTypes |     10 | TwitterHandleRequired | true   |              |           |              |           | v2Depricated |

  @OutletlistwithapiOutletIds @API-V2
  Scenario Outline: 9. Call Outlets webservice with APIOutletId parameter
    ...
    Examples: 
      | Parameter    | parameterValue           | Version      |
      | ApiOutletIDs | FOCQrIipn63WUXvCppsiNg== | v2Depricated |

  @OutletlistwithTwitterHandle @API-V2
  ...
  Scenario Outline: 13. API V2||  Outlets || Using Sortby ASC
    ...
    Examples: 
      ...
      | Names     | bbc            |      1 |     1 | outletName       | v2Depricated |
      | Names     | bbc            |      2 |     1 | outletType       | v2Depricated |
      | Names     | bbc            |      3 |     1 | primaryMediaType | v2Depricated |
      | Names     | bbc            |      4 |     1 | country          | v2Depricated |
  ...
  Scenario Outline: 14. API V2||  Outlets || Using Sortby DESC
    ...
    Examples: 
      | Parameter | parameterValue | sortby | order | value            | Version      |
      | Names     | bbc            |      1 |     0 | outletName       | v2Depricated |
      | Names     | bbc            |      2 |     0 | outletType       | v2Depricated |
      | Names     | bbc            |      3 |     0 | primaryMediaType | v2Depricated |
      | Names     | bbc            |      4 |     0 | country          | v2Depricated |
  ...
  Scenario Outline: 15. API V2||  Outlets || Using Smart sort as true
    ...
    Examples: 
      ...
      | Names     | bbc            | true      | outletName | v2Depricated |

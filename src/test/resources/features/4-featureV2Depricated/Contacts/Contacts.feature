@ContactsV2V2Depricated @ContactsV2Depricated @Depricated
Feature: || Contacts Endpoint|| API V2Depricated||
  ...
  @contactlistwithNoParameterv2 @WEBAPIAutomation @API-V2Depricated
  ...
  @contactlistwithSingleParameterv2 @WEBAPIAutomation @API-V2Depricated
  Scenario Outline: 2. Call webservice to get the contact list using single parameter and verify response
    ...
    Examples: 
      ...
      | Names               | Thomas                                       | contactName        | v2Depricated |
      | ApiOutletContactIDs | L3gnHqTZIAkI5mougxu/kCSsxWskhYMTark+CiIM3T8= | apiOutletContactID | v2Depricated |
      | ContactNames        | Aaron Thomas                                 | contactName        | v2Depricated |
      | OutletNames         | KVLD-FM                                      | outletName         | v2Depricated |
      | ApiOutletIDs        | H6iW/7BMp3+26kR5C2pwFA==                     | apiOutletID        | v2Depricated |
      | ApiContactIDs       | 9FtsXCIr/RK2bpCqaw3Afg==                     | apiContactID       | v2Depricated |

  @contactlistwithtwoParameterv2 @WEBAPIAutomation @API-V2Depricated
  Scenario Outline: 3. Call webservices to get the contact list using two parameter and verify response
    ...
    Examples: 
      ...
      | Names      | Thomas | /api/2.1/data/jobRoleLookup    | jobRoles           | v2Depricated |
      | Names      | Thomas | /api/2.1/data/geographyLookup  | LocatedIn          | v2Depricated |
      | Names      | Thomas | /api/2.1/data/languageLookup   | Languages          | v2Depricated |
      | Names      | Thomas | /api/2.1/data/frequencyLookup  | Frequencies        | v2Depricated |
      | Names      | John   | /api/2.1/data/newsFocusLookup  | NewsFocuses        | v2Depricated |
      | Names      | John   | /api/2.1/data/mediaTypeLookup  | MediaTypes         | v2Depricated |
      | Names      | John   | /api/2.1/data/outletTypeLookup | OutletTypes        | v2Depricated |
      | Names      | Thomas | /api/2.1/data/subjectLookup    | WritingAbout       | v2Depricated |
      | Names      | John   | /api/2.1/data/subjectLookup    | OutletWritingAbout | v2Depricated |

  @contactlistwithSubjectParameterv2 @WEBAPIAutomation @API-V2Depricated @Sanity
  Scenario Outline: 4. Call webservices to get the contact list using Subject parameter and verify response
    ...
    Examples: 
      ...
      | WritingAbout       |  1414 | v2Depricated |
      | OutletWritingAbout |  1414 | v2Depricated |

  @contactlistwithAllParameterv2 @WEBAPIAutomation @API-V2Depricated @Sanity
  Scenario Outline: 5. Call webservices to get the contact list and verify response
    ...
    Examples: 
      ...
      | ApiContactIDs | 5vCnAa+eKPuymQNdSEQV2g== | ApiOutletContactIDs | jKlIfX4z33Ql8AeWpP8gVTbYtKrWzVSiLK4Va9z+Sy4= | Names      | Retd) John | WritingAbout |    698 | JobRoles   |      4 | MediaTypes |      4 | Frequencies |      7 | OutletNames | Tank Magazine | ApiOutletIDs | gzZ6TZEpI9MzSWV+PTL7yA== | OutletWritingAbout |     698 | v2Depricated |

  @contactlistwithThreeParameterv2 @WEBAPIAutomation @API-V2Depricated
  Scenario Outline: 6. Call webservices to get the contact list using three parameter and verify response
    ...
    Examples: 
      ...
      | ApiContactIDs | 5vCnAa+eKPuymQNdSEQV2g== | ApiOutletContactIDs | jKlIfX4z33Ql8AeWpP8gVTbYtKrWzVSiLK4Va9z+Sy4= | Names      | Retd) John | v2Depricated |

  @contactlistwithTwitterHandlev2 @API-V2Depricated
  Scenario Outline: 7. Call webservices to get the contact list using twitter handle and verify response
    ...
    Examples: 
      ...
      | Names     | Thomas         | true               | twitterHandleRequired | v2Depricated |

  @contactlistwitIndexParameterv2 @API-V2Depricated
  Scenario Outline: 8. Call webservices to get the contact list using index parameter and verify response
    ...
    Examples: 
      ...
      | Names     | Thomas         | PageNumber |     1 | v2Depricated |

  @contactlistWithItemsPerPageParameterv2 @API-V2Depricated
  Scenario Outline: 9. Call webservices to get the contact list using item per page and verify response
    ...
    Examples: 
      ...
      | Names     | Thomas         | PageSize   |              50 | v2Depricated |

  @contactWithSortByASCv2 @API-V2Depricated
  Scenario Outline: 10. Call webservices to get the contact list using sort by ASC and verify response
    ...
    Examples: 
      ...
      | Names      | Thomas          | sortBy     |               1 | order      |               1 | contactName | v2Depricated |
      | Names      | Thomas          | sortBy     |               3 | order      |               1 | JobTitle    | v2Depricated |
      | Names      | Thomas          | sortBy     |               4 | order      |               1 | MediaType   | v2Depricated |
      | Names      | Thomas          | sortBy     |               5 | order      |               1 | Country     | v2Depricated |
      | Names      | Thomas          | sortBy     |               6 | order      |               1 | City        | v2Depricated |
      | Names      | Thomas          | sortBy     |               7 | order      |               1 | LastName    | v2Depricated |
      | Names      | Thomas          | sortBy     |               8 | order      |               1 | Audience    | v2Depricated |

  @contactWithSortByDESCv2 @API-V2Depricated
  Scenario Outline: 11. Call webservices to get the contact list using sort by DSC and verify response
    ...
    Examples: 
      | Parameter1 | parameterValue1 | parameter2 | parameterValue2 | parameter3 | parameterValue3 | value       | Version      |
      | Names      | Thomas          | sortBy     |               1 | order      |               2 | contactName | v2Depricated |
      | Names      | Thomas          | sortBy     |               2 | order      |               2 | outletName  | v2Depricated |
      | Names      | Thomas          | sortBy     |               3 | order      |               2 | JobTitle    | v2Depricated |
      | Names      | Thomas          | sortBy     |               4 | order      |               2 | MediaType   | v2Depricated |
      | Names      | Thomas          | sortBy     |               5 | order      |               2 | Country     | v2Depricated |
      | Names      | Thomas          | sortBy     |               6 | order      |               2 | City        | v2Depricated |
      | Names      | Thomas          | sortBy     |               7 | order      |               2 | LastName    | v2Depricated |
      | Names      | Thomas          | sortBy     |               8 | order      |               2 | Audience    | v2Depricated |

  @contactWithSmartSortv2 @API-V2Depricated
  Scenario Outline: 12. Call webservices to get the contact list using smart sort and verify response
    ...
    Examples: 
      ...
      | Names     | Thomas         | smartSort  | true            | contactName | v2Depricated |
      | Names     | Thomas         | smartSort  | true            | JobTitle    | v2Depricated |
      | Names     | Thomas         | smartSort  | true            | MediaType   | v2Depricated |

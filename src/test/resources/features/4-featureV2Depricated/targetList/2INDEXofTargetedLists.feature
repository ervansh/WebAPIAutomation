@TargetedListIndexV2 @TargetedLists @Depricated
Feature: ||TargetedLists||TargetedListIndex Endpoint || API v2Depricated ||
  ...
  Scenario Outline: 1. Call TargetedListIndex Endpoint and Get all targeted lists and verify the response
    ...
    Examples: 
      ...
      | v2Depricated      | id         | name       |

  @TargetedListUsingItemsPerPageD @TargetedLists @API-V2
  Scenario Outline: 2. Call TargetedListIndex Endpoint with page index and verify the response
    ...
    Examples: 
      ...
      | v2Depricated      | id         | ReturnedResults | limit        |    1 |

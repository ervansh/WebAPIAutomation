@CREATENewTargetedList @TargetedLists @Depricated
Feature: ||TargetedLists|| CREATENewTargetedList Endpoint || API v2Depricated ||
  ...
  @CreateNewTargetedList @TargetedLists @API-v2Depricated @Sanity
  Scenario Outline: 1. Call CREATENewTargetedList Endpoint and Create a new Targeted Lists and verify the response
    ...
    Examples: 
      ...
      | v2Depricated | ListName   | APIOutletContactIDs | TargetedList-Sonali | XE818YyjFFjMWklV20QINtYptQfcRkc7kklnpLEDMx4= | targetedListID | targetedListName |

  @CreateNewTargetedListUsingList @TargetedLists @API-v2Depricated
  Scenario Outline: 2. Call CREATENewTargetedList Endpoint and Create a new Targeted Lists using a already created list and verify the response
    ...
    Examples: 
      ...
      | v2Depricated | ListName   | APIOutletContactIDs | TargetedListIDs | TargetedList-Sonali | Z5vVPOJcDCi9bZNbjo8K9xO4LgAGeFmfj0CW7uiKq/o= | targetedListID | targetedListName |

@outletQuickSearch @Search @Depricated
Feature: ||Search ||OutletQuickSearch Endpoint ||API v2Depricated||
  ...
  @outletnameQuickSearch @API-V2 @Sanity
  Scenario Outline: 1. Call OutletQuickSearch webservice for contact and verify response
    ...
    Examples: 
      ...
      | v2Depricated | Name       | BBC   |

  @TwoParameterKeywordSearchV2 @API-V2
  Scenario Outline: 2. Call Two Parameter Keyword search webservice and verify response
    ...
    Examples: 
      ...
      | v2Depricated | Name       | BBC    | GeographyIDs |  54295 |

  @outletQuickSearchforSortbyASCV2 @API-V2
  ...
  @outletQuickSearchforSortbyDSC @API-V2

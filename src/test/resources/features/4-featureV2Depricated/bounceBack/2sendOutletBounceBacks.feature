@MediaResearch @OutletBounceBacks @Depricated
Feature: ||MediaResearch || OutletBounceBacks Endpoint|| API v2Depricated ||
  ...
  Scenario Outline: 1. Call OutletBounceBacks webservice and verify response
    ...
    Examples: 
      ...
      | APIOutletID | mfs29i8DKChieBAYE0g9Gg== | v2Depricated | BounceBackEmail |

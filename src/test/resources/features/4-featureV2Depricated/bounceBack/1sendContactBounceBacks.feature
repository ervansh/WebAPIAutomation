@MediaResearch @ContactBounceBacks @Depricated
Feature: ||MediaResearch || ContactBounceBacks Endpoint|| API V2Depricated ||
         1. Call ContactBounceBacks webservice and verify response

  @ContactBounceBacks @API-V2v2Depricated
  Scenario Outline: 1. Call ContactBounceBacks webservice and verify response
    ...
    Examples: 
      ...
      | APIOutletContactID | L3gnHqTZIAkI5mougxu/kCSsxWskhYMTark+CiIM3T8= | v2Depricated | BounceBackEmail |
